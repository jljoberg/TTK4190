...
if should_print; print('3d_fig_course', '-depsc'); end 
%% Plot Aileron input
figure
...
if should_print; print('3d_fig_aileron', '-depsc'); end 
%% Plot roll angle
figure
...
if should_print; print('3d_fig_roll', '-depsc'); end
%% Plot roll rate
figure
...
if should_print; print('3d_fig_roll_rate', '-depsc'); end
%% Plot yaw rate
...
if should_print; print('3d_fig_yaw_rate', '-depsc'); end